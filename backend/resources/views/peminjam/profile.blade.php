    ...
    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="bg-gray-800 px-6 py-5">
            ...
            <p class="text-sm text-gray-300 mt-1">
                Kelola informasi profil akun peminjam
            </p>
            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="flex justify-center md:w-1/3">
                    ...
                    <div class="text-center">
                        ...
                        <!-- FORM GANTI FOTO -->
                        <form
                            action="{{ route('peminjam.profile.updateFoto') }}"
                            method="POST"
                ...
                <div class="flex-1">
                    ...
                    <!-- FORM DATA PROFIL -->
                    <form
                        action="{{ route('peminjam.profile.update') }}"
                        method="POST"
                    >
                        ...
                        <div class="flex justify-end">
                            ...
                            <button
                                type="submit"
                                class="px-5 py-2.5 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 transition"
                            >
                                Simpan Perubahan
                            </button>
